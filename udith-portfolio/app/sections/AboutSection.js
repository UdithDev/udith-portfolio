  ...
  JavaScript: ({ hovered }) => (
    <svg viewBox="0 0 128 128" className="w-10 h-10">
      <rect
        width="128"
        height="128"
        fill={hovered ? "#F7DF1E" : "#4B5563"}
        rx="6"
        style={{ transition: "fill 0.4s ease" }}
      />
      <path
        fill={hovered ? "#000" : "#9CA3AF"}
        style={{ transition: "fill 0.4s ease" }}
  ...
  "Next.js": ({ hovered }) => (
    <svg viewBox="0 0 128 128" className="w-10 h-10">
      <circle
        ...
        cy="64"
        r="64"
        fill={hovered ? "#000000" : "#374151"}
        style={{ transition: "fill 0.4s ease" }}
      />
      <path
        fill={hovered ? "#ffffff" : "#9CA3AF"}
        style={{ transition: "fill 0.4s ease" }}
    ...
    <svg viewBox="0 0 128 128" className="w-10 h-10">
      <defs>
        <linearGradient id="azureGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop
            offset="0%"
            stopColor={hovered ? "#0078D4" : "#374151"}
            style={{ transition: "stop-color 0.4s ease" }}
          />
          <stop
            offset="100%"
            stopColor={hovered ? "#50E6FF" : "#4B5563"}
            style={{ transition: "stop-color 0.4s ease" }}
          />
        </linearGradient>
      </defs>
      <path fill="url(#azureGrad)" d="M47.6 8h36.3L49.3 120H13L47.6 8z" />
      <path
        fill={hovered ? "#50E6FF" : "#6B7280"}
        style={{ transition: "fill 0.4s ease" }}
        d="M80.4 8h32.6L68.3 62.5l24.2 38.7H52.2L80.4 8z"
      />
      <path
        fill={hovered ? "#0078D4" : "#4B5563"}
        style={{ transition: "fill 0.4s ease" }}
...
const skillsData = [
  ...
  },
  {
    ...
    barColor: "from-green-500 to-green-700",
    category: "Framework",
  },
  {
    name: "Azure",
    ...
    barColor: "from-blue-300 to-cyan-500",
    category: "Cloud",
  },
  {
    name: "MySQL",
    ...
    barColor: "from-orange-400 to-blue-500",
    category: "Database",
  },
...
export default function About() {
  const experiences = [
    ...
    },
    {
      ...
      company: "University of Bedfordshire, UK",
  ...
  return (
    <section id="about" className="py-24 bg-gray-900 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
        ...
        >
          <span className="text-blue-400 font-mono text-xs tracking-[4px] uppercase mb-3 block">
            Get to know me
          </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start mb-24">
          ...
          >
            ...
            <div className="text-gray-400 text-sm leading-relaxed space-y-3 mt-2">
              <p>
                Graduate Software Engineer with a{" "}
                <span className="text-white font-medium">
                  First Class Honours
                </span>{" "}
                degree from the University of Bedfordshire. Over 3 years of
                hands-on development experience.
              </p>
              <p>
                Currently specializing in{" "}
                <span className="text-blue-400 font-medium">.NET MVC</span> and{" "}
          ...
          >
            ...
            <div className="relative space-y-0">
              ...
              {experiences.map((exp, index) => (
                ...
                >
                  <div
                    className={`absolute left-[-5px] top-1.5 w-2.5 h-2.5 rounded-full border-2 z-10 transition-all duration-300
                    ${
                      exp.type === "work"
                  ...
                  />
                  <span
                    className={`inline-flex items-center gap-1 text-[10px] font-semibold tracking-widest uppercase px-2 py-0.5 rounded-full mb-1.5
                    ${
                      exp.type === "work"
        ...
        >
          ...
          <p className="text-gray-600 text-xs mb-8 pl-9 font-mono">
